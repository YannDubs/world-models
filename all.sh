...
echo "control" >> $log
xvfb-run -a -s "-screen 0 1400x900x24" python traincontroller.py --logdir all_dir --n-samples 4 --pop-size 4 --max-workers 16 --target-return 950 --is-gate --max-epoch 200 --display
